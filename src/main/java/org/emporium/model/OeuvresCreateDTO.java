...
public class OeuvresCreateDTO {
    ...
    public OeuvresCreateDTO(String titre, String sousTitre, String description, String image, String idType, String idAuteur, String idEditeur, String idSupport, String idGenre) {
        this.titre = titre;
